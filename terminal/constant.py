...
POSITION_REASON_CLIENT = 0  # The position was opened as a result of activation of an order placed from a desktop mt5_adapter
...
class POSITION_REASON(enum.IntEnum):
    CLIENT = 0  # The position was opened as a result of activation of an order placed from a desktop mt5_adapter
...
class ENUM_ORDER_TYPE_TIME(enum.IntEnum):
...
# ENUM_ORDER_REASON
ORDER_REASON_CLIENT = 0  # The order was placed from a desktop mt5_adapter
...
class ORDER_REASON(enum.IntEnum):
    CLIENT = 0  # The order was placed from a desktop mt5_adapter
...
# ENUM_DEAL_REASON
DEAL_REASON_CLIENT = 0  # The deal was executed as a result of activation of an order placed from a desktop mt5_adapter
...
class DEAL_REASON(enum.IntEnum):
    CLIENT = 0  # The deal was executed as a result of activation of an order placed from a desktop mt5_adapter
...
RES_X_TERMINAL_VERSION_OUTDATED = -200_002  # mt5_adapter version is out of date and does not support the current feature.
...
class ERROR_CODE(enum.IntEnum):
    ...
    TERMINAL_VERSION_OUTDATED = -200_002  # mt5_adapter version is out of date and does not support the current feature.
